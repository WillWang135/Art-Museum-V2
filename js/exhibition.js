...
/* The presentation module owns this ready helper on dev. This duplicate does
   not include presentations, so retain the same timing locally without
   importing that unrelated feature. */
function onExhibitionReady(fn) {
  if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", fn);
  else fn();
}

onExhibitionReady(() => { loadBuiltinExhibition(); });
